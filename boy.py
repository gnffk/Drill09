...
class StateMachine:
    def __init__(self, boy):
        ...
        self.table = {
            ...
            Run: {right_down: Idle, left_down: Idle, left_up: Idle, right_up: Idle ,A: AutoRun},
            Sleep: {right_down: Run, left_down: Run, left_up: Run, right_up: Run, space_down: Idle,A:AutoRun},
